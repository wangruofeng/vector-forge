export const COPY = {
  en: {
    ...
    preview: 'Preview', source: 'Source', format: 'Format', resetView: 'Reset view and center', collapseLayers: 'Collapse layers', expandLayers: 'Expand layers', collapseInspector: 'Collapse properties', expandInspector: 'Expand properties', dropHint: 'Drop an SVG anywhere to begin', inspector: 'Inspector', appearance: 'Appearance',
    ...
    shortcutUndo: 'Undo', shortcutRedo: 'Redo', shortcutExport: 'Export SVG', shortcutSelectAll: 'Select all layers', shortcutCopy: 'Copy layer', shortcutPaste: 'Paste layer', shortcutDelete: 'Delete layer', shortcutPanels: 'Cycle panels', shortcutHelp: 'Toggle shortcuts panel', shortcutPan: 'Pan canvas', shortcutZoom: 'Zoom in / out', shortcutEditText: 'Edit text content', shortcutDeselect: 'Clear selection', shortcutZoomIn: 'Zoom in', shortcutZoomOut: 'Zoom out', shortcutZoomFit: 'Fit to screen',
    shortcutKeyDrag: 'Drag', shortcutKeyScroll: '⌘ + Scroll', shortcutKeyDoubleClick: 'Double-click',
    exportDialogTitle: 'Export', exportFormat: 'Format', exportScale: 'Scale', exportBackground: 'Background', exportTransparent: 'Transparent', exportWhite: 'White', exportCustom: 'Custom', exportOptimize: 'Optimize & minify SVG', exportFailed: 'Export failed',
    ...
    share: 'Share', shareCopied: 'Share link copied', shareFailed: 'Could not create share link', sharedOpened: 'Shared document opened',
    storageFull: 'Local storage is full — changes may not be saved',
  },
  zh: {
    languageSwitch: 'English', saved: '所有更改已保存', unsaved: '有未保存的更改', open: '导入 SVG', export: '导出',
    ...
    preview: '预览', source: '源码', format: '格式化', resetView: '重置视图并居中', collapseLayers: '折叠图层面板', expandLayers: '展开图层面板', collapseInspector: '折叠属性面板', expandInspector: '展开属性面板', dropHint: '将 SVG 拖到这里开始', inspector: '检查器', appearance: '外观',
    ...
    share: '分享', shareCopied: '分享链接已复制', shareFailed: '生成分享链接失败', sharedOpened: '已打开分享的文档',
